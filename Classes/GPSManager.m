		...
		switch(_id) {
			...
			case 5:
				if(gpsControllers5==nil)
					gpsControllers5=[[GFiController alloc] initWithDelegate:del];
				gps=gpsControllers5;
				break;
			case 6:
				if(gpsControllers6==nil)
					gpsControllers6=[[FakeGPSController alloc] initWithDelegate:del];
				gps=gpsControllers6;
